...
import edu.wgu.grimes.c868pa.adapters.AssessmentAdapter;
...
import edu.wgu.grimes.c868pa.viewmodels.CourseEditorViewModel;

import static edu.wgu.grimes.c868pa.utilities.Constants.COURSE_ID_KEY;
import static edu.wgu.grimes.c868pa.utilities.Constants.END;
import static edu.wgu.grimes.c868pa.utilities.Constants.START;
...
public class CourseEditorActivity extends AbstractEditorActivity implements NumberPicker.OnValueChangeListener {
    ...
    protected void initViewModel() {
        ...
        mViewModel.mLiveCourse.observe(this, (course) -> {
            if (course != null) {
                mTitle.setText(state.title == null ? course.getCourseTitle() : state.title);
                ...
                mStatus.setSelection(state.status == null ? statusAdapter.getPosition(course.getCourseStatus()) : state.status);
